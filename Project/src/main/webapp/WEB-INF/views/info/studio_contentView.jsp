...
<!-- 		<span id="sub_Color_f"><a href="/gallary/gallary_list.asp?data=72&amp;data2=76">본식사진</a></span>
		<span id="sub_Color_f"><a href="/gallary/gallary_etc_list.asp?data=93">허니문</a></span>
		<span id="sub_Color_f"><a href="/gallary/gallary_etc_list.asp?data=92">한복</a></span>
		<span id="sub_Color_f"><a href="/gallary/gallary_etc_list.asp?data=91,147">예물</a></span>
		<span id="sub_Color_f"><a href="/gallary/gallary_etc_list.asp?data=98">예복</a></span>
		<span id="sub_Color_f"><a href="/gallary/gallary_etc_list.asp?data=94,95,96">주례/사회/축가</a></span>
		<span id="sub_Color_f"><a href="/gallary/gallary_etc_list.asp?data=97,214">폐백/이바지</a></span>
		<span id="sub_Color_f"><a href="/gallary/gallary_etc_list.asp?data=100">DVD/영상</a></span>
		<span id="sub_Color_f"><a href="/gallary/gallary_etc_list.asp?data=112,114,149,354,141,142">청첩장/스킨케어/케이터링/기타</a></span>
		<span id="sub_Color_f"><a href="/gallary/gallary_etc_list.asp?data=101,102,157">혼수/예단/가구/가전</a></span>
		<span id="sub_Color_f"><a href="/gallary/gallary_etc_list.asp?data=74">부케</a></span>
		<span id="sub_Color_f"><a href="/gallary/gallary_etc_list.asp?data=158,203">답례품</a></span> -->
	</div>
</div>
<script src="//dapi.kakao.com/v2/maps/sdk.js?appkey=6712e4bb7d58b0d52aa3494f40c12c46"></script><script charset="UTF-8" src="http://t1.daumcdn.net/mapjsapi/js/main/4.3.2/kakao.js"></script>
...
<!--
	...
	function load_naver_view()
	{
		var mapContainer = document.getElementById('navermap'), // 지도를 표시할 div 
			mapOption = {
				center: new daum.maps.LatLng(37.5134122745267, 127.039853691281), // 지도의 중심좌표
				level: 3, // 지도의 확대 레벨
		...
		var marker = new daum.maps.Marker({
			position: new daum.maps.LatLng(37.5134122745267, 127.039853691281), // 마커의 좌표
			...
			function()
			{
					...
					(
						function()
						{
							...
							temp_width = Math.round(web_width/2)-100;
				...
				$('#lay_email3').change(function() {
					var data = $(this).val();		
					if (data)
					{
						$('#lay_email2').val(data).attr("readonly",true);
					}else{
						$('#lay_email2').val(data).attr("readonly",false);
					}
				});

				$('#btn_layer_ok').click(function() {				
					var qIdx = $('#qIdx').val();	//업체코드번호
					var qName = $('#qName').val();	//업체명
					var mIdx = $('#mIdx').val();	//회원번호
					var lay_name = $('#lay_name').val();
					var lay_phone1 = $('#lay_phone1').val();
					var lay_phone2 = $('#lay_phone2').val();
					var lay_phone3 = $('#lay_phone3').val();					
					var lay_cusEnter = $('#lay_cusEnter').val();					
					var lay_content = $('#lay_content').val();					
					if (!lay_name)
					{
						alert("이름을 입력해 주세요!");
						$('#lay_name').focus();
					...
					$.ajax({
						...
						, data:{gubun: '컬렉션상담', category: '컬렉션상담', qidx: qIdx, title: qName, sex: '', name: lay_name, phone1: lay_phone1, phone2: lay_phone2, phone3: lay_phone3, cusEnter: lay_cusEnter, content: lay_content}	
				...
				(
					function()
					{
						...
						parent.$("div[id=wrap]").css({
							"opacity": "1.0","width":"100%","height":"100%"
						});					
						parent.$("#preview_layer").hide();
					}
				);				

				$("*[id='btn_bottom_layer']").click
				(
					function()
					{
						var movy = $(this).position().top;
						var movx = $(this).position().left;
						
						if($(this).attr("data")=="right")
						{
							$("#layer_consult_view").css("top",movy+$(this).height()).css("left",(movx-$("#layer_consult_view").width())+$(this).width());
						}
						else
						{
							$("#layer_consult_view").css("top",movy+$(this).height()).css("left",movx);
						}
						
						$("#layer_consult_view").show();
					}
				);

				$("*[id='btn_layer_close']").click
				(
					function()
					{
						$("#layer_consult_view").hide();
					}
				);
				...
				(
					function()
					{
						...
						{							
							...
							$("#div_daum").hide();
							$("#map_img").hide();
							$("#btn_img_prev_one").hide();
							$("#btn_img_next_one").hide();
							
							$("img[id=nmap]").attr({src: "../images/naver_off.gif"});
							$("img[id=nmap]").attr("data1","0");
							
							$("img[id=dmap]").attr({src: "../images/daum_off.gif"});
							$("img[id=dmap]").attr("data1","0");

							$("img[id=consult_btn]").attr({src: "../images/consult_off.jpg"});
							$("img[id=consult_btn]").attr("data1","0");

							$(this).attr({src: "../images/video_on.gif"});
							$(this).attr("data1","1");							
							if (!data)
							{
								$("#view_detail_image").html("<img src=../images/video_no_img.jpg>");
							}else {
								$("#view_detail_image").html(data);
							}
						}
						if (data1 == "1")
						{							
							...
							$(this).attr({src: "../images/video_off.gif"});
							$(this).attr("data1","0");

							$("#view_detail_image").html('<img src=http://vgood.co.kr/admin/contentsImg/client/202012/039.jpg>');							
						}						
					}
				);

				$("*[id='consult_btn']").click
				(
					function()
					{						
						var data = $(this).attr("data");						
						...
						{							
							...
							$("img[id=movie_btn]").attr({src: "../images/video_off.gif"});
							$("img[id=movie_btn]").attr("data1","0");

							$(this).attr({src: "../images/consult_on.jpg"});
							$(this).attr("data1","1");
							
							$("#view_detail_image").html('');
						}
						if (data1 == "1")
						{							
							$(".rolling_logo").show();
							...
							$(this).attr({src: "../images/consult_off.jpg"});
							$(this).attr("data1","0");
				...
				$("img[id='estimate_btn']").click
				(
					function()
					{												
						var cIdx = $(this).attr("data");						
						location.href = "/counselling/consult.asp?cIdx="+cIdx;
					}
				);
				...
				(
					...
					{						
						...
						{							
							...
							$(this).attr({src: "../images/naver_on.gif"});
							$(this).attr("data1","1");							
							load_naver_view();
						}
						if (data1 == "1")
						{							
							...
							$(this).attr({src: "../images/naver_off.gif"});
							$(this).attr("data1","0");
				...
				(
					...
					{										
						...
						{							
							...
							$(this).attr({src: "../images/daum_on.gif"});
							$(this).attr("data1","1");							
							load_view();
						}
						if (data1 == "1")
						{							
							...
							$(this).attr({src: "../images/daum_off.gif"});
							$(this).attr("data1","0");
...
<!--왼쪽사진영역-->
        ...
        <!--스튜디오제목과 링크-->
        	<div class="pic_top">
          	<div class="pic_top_linkbx"><span class="popup_store_tx">${map.stuDto.c_name } <!--[<span id="now_img_order" style="color:#ed5900"></span>/<span id="max_img_size"></span>]--></span></div>
            </div>
            <script type="text/javascript">
<!--
	...
	(
		function()
		{
			...
			function view_image_start(page,min)
			{
				...
				var view_image_arry = view_image_str.split('ⓒⓗⓡ⑬');
				var view_image_len = view_image_arry.length;
				
				
				$("#max_img_size").text(view_image_len);

				var view_num = 10;
				
				var total_page_num = Math.floor((view_image_len-1)/view_num)+1;
				...
				//보여질 이미지의 마지막 배열
				var loop_end = start_num + view_num;
				...
				for (var i =start_num ; i<loop_end; i++)
				{
					...
					var view_image_sub_arry = view_image_sub_str.split('ⓒⓗⓡ⑨');
					...
					var big_size = get_img_size(big_img, 900, 592, "size");
					var big_size_arry = big_size.split(",");
					...
					view_image_list = view_image_list+"<li><img src="+img_url+" id='img_hall_info' data1='"+img_title+"' data2='"+img_order+"' data_w='"+big_x+"' data_h='"+big_y+"' width='75' height='50' style='cursor:pointer;'/><span id='layer_"+img_order+"' class='layer_all'></span></li>"	
				...
				$(".layer_all").html('');
				$("#view_image_area").html(view_image_list);				
				$("#view_detail_image").html("<img src='"+review_image+"' onload='resize(this)' />");
				$("#now_img_order").text(fst_order);				
				layer_image2 = "<img src='../images/small_hover.png' class='view_SM_pngpic' />"
				$("span[id=layer_"+fst_order+"]").html(layer_image2);				
				$("#btn_img_next_one").attr("data",fst_order-1);
				$("#btn_img_prev_one").attr("data",fst_order-1);
			}
			...
			(
				function()
				{
					...
					if(view_image_page==0)
					{
						...
						view_image_start(view_image_page,0)
					}
					else
					{
						view_image_page--;
			...
			function view_image_start_one(page,min)
			{
				...
				var view_image_one_arry = view_image_str_one.split('ⓒⓗⓡ⑬');
				var view_image_one_len = view_image_one_arry.length;				
				
				$("#max_img_size").text(view_image_one_len);

				var view_num_one = 1;
				
				var total_page_num_one = Math.floor((view_image_one_len-1)/view_num_one)+1;
				
				max_imge_page_one = total_page_num_one;

				//시작하는 배열의 위치
				var start_num_one = view_num_one*page;

				//보여질 이미지의 마지막 배열
				var loop_end_one = start_num_one + view_num_one;
				...
				for (var i =start_num_one ; i<loop_end_one; i++)
				{
					...
					view_thumb_image_list = view_thumb_image_list+"<li><img src="+img_url+" id='img_hall_info' data1='"+img_title+"' data2='"+img_order+"' data_w='"+big_x+"' data_h='"+big_y+"' width='75' height='50' style='cursor:pointer;'/><span id='layer_"+img_order+"' class='layer_all'></span></li>"	
			...
			$("span[id=btn_img_next_one]").click
			(
				function()
				{	
					var view_image_page_one = $(this).attr("data");
					total_page = Math.floor((max_imge_page_one-1)/view_one_page_num)+1;					
					...
					{						
						...
						view_image_start_one(view_image_page_one,0)						
					}
					else
					{					
						view_image_page_one++;
						...
						{
							if((view_image_page_one) == k*view_one_page_num)
							{							
								view_image_page++;
								view_image_start(view_image_page,0)
							}							
					...
					$("#btn_img_next_one").attr("data",view_image_page_one);
					$("#btn_img_prev_one").attr("data",view_image_page_one);
				}
			);

			$("#btn_img_prev_one").click
			(
				function()
				{				
					var view_image_page_one = $(this).attr("data");
					...
					{						
						...
						for (k=1;k<total_page;k++)
						{
							...
							{							
								view_image_page--;
								view_image_start(view_image_page,0)
								view_image_start_one((view_one_page_num*k)-1,0)
							}							
						}												
					}
					$("#btn_img_prev_one").attr("data",view_image_page_one);
	...
	$(document).on
	(
		"click","img[id='img_hall_info']",
		function()
		{
			var data_src = $(this).attr("src");
			var data_title = $(this).attr("data1");
			var data_order = $(this).attr("data2");
			var data_w = $(this).attr("data_w");
			var data_h = $(this).attr("data_h");

			$("#btn_img_next_one").attr("data",data_order-1);
			$("#btn_img_prev_one").attr("data",data_order-1);				
			...
			$("#view_detail_image").html("<img src='"+data_src+"' onload='resize(this)'/>");
			$("#now_img_order").text(data_order);
			$("#hall_imag_title").text(data_title);
			layer_image = "<img src='../images/small_hover.png' class='view_SM_pngpic' />"
			$("span[id=layer_"+data_order+"]").html(layer_image);
	...
	//-->
			...
			<div id="pic_top_rolling">
            	<div style="position:relative;" class="pic_top_PICbx">
					<p align="center" id="view_detail_image"><img src="http://vgood.co.kr/admin/contentsImg/client/202012/039.jpg" onload="resize(this)" width="900" height="592"></p>
					<div style="position:absolute;left:25px;top:260px;z-index:100;">
						<span id="btn_img_prev_one" style="cursor:pointer;" data="0"><img src="/images/button/view_img_prev.png"></span>
					</div>
					<div style="position:absolute;right:25px;top:260px;z-index:100;">
						<span id="btn_img_next_one" style="cursor:pointer;" data="0"><img src="/images/button/view_img_next.png"></span>
					</div>
                    <div class="pic_numwrap" style="width:100%; text-align:center; line-height:1.2; margin-top:2px;padding-top:3px;">
						<span style="display:block;font-size:15px;"><span id="now_img_order" style="color:#ed5900;">1</span>/<span id="max_img_size">47</span></span>
					</div>
				</div>
               <p class="rolling_prev"><img src="../images/popup/img_rolling_prev.png" id="btn_img_prev" style="cursor:pointer;" alt="이전이미지"></p>
               <p class="rolling_next"><img src="../images/popup/img_rolling_next.png" id="btn_img_next" style="cursor:pointer;" alt="다음이미지"></p>
               
               <ul class="rolling_wrap">
                	<span id="view_image_area"><li><img src="http://vgood.co.kr/admin/contentsImg/client/202012/039.jpg" id="img_hall_info" data1="" data2="1" data_w="900" data_h="592" width="75" height="50" style="cursor:pointer;"><span id="layer_1" class="layer_all"><img src="../images/small_hover.png" class="view_SM_pngpic"></span></li><li><img src="http://vgood.co.kr/admin/contentsImg/client/202012/001.jpg" id="img_hall_info" data1="" data2="2" data_w="900" data_h="592" width="75" height="50" style="cursor:pointer;"><span id="layer_2" class="layer_all"></span></li><li><img src="http://vgood.co.kr/admin/contentsImg/client/202012/002.jpg" id="img_hall_info" data1="" data2="3" data_w="900" data_h="592" width="75" height="50" style="cursor:pointer;"><span id="layer_3" class="layer_all"></span></li><li><img src="http://vgood.co.kr/admin/contentsImg/client/202012/003.jpg" id="img_hall_info" data1="" data2="4" data_w="900" data_h="592" width="75" height="50" style="cursor:pointer;"><span id="layer_4" class="layer_all"></span></li><li><img src="http://vgood.co.kr/admin/contentsImg/client/202012/004.jpg" id="img_hall_info" data1="" data2="5" data_w="900" data_h="592" width="75" height="50" style="cursor:pointer;"><span id="layer_5" class="layer_all"></span></li><li><img src="http://vgood.co.kr/admin/contentsImg/client/202012/005.jpg" id="img_hall_info" data1="" data2="6" data_w="900" data_h="592" width="75" height="50" style="cursor:pointer;"><span id="layer_6" class="layer_all"></span></li><li><img src="http://vgood.co.kr/admin/contentsImg/client/202012/006.jpg" id="img_hall_info" data1="" data2="7" data_w="900" data_h="592" width="75" height="50" style="cursor:pointer;"><span id="layer_7" class="layer_all"></span></li><li><img src="http://vgood.co.kr/admin/contentsImg/client/202012/007.jpg" id="img_hall_info" data1="" data2="8" data_w="900" data_h="592" width="75" height="50" style="cursor:pointer;"><span id="layer_8" class="layer_all"></span></li><li><img src="http://vgood.co.kr/admin/contentsImg/client/202012/008.jpg" id="img_hall_info" data1="" data2="9" data_w="900" data_h="592" width="75" height="50" style="cursor:pointer;"><span id="layer_9" class="layer_all"></span></li><li><img src="http://vgood.co.kr/admin/contentsImg/client/202012/009.jpg" id="img_hall_info" data1="" data2="10" data_w="900" data_h="592" width="75" height="50" style="cursor:pointer;"><span id="layer_10" class="layer_all"></span></li></span>					
               </ul>
               </div>
			<div id="map_img" class="map_img" style="position:absolute;left:12px;top:85px;display:none;">
				<div style="width:30px;height:30px;position:absolute;left:15px;top:10px;z-index:100;"><img src="/images/button/btn_pop_close.png" id="closemap" width="30" height="30" style="cursor:pointer;"></div>
				<div id="div_naver" style="display:none;"><div id="navermap" style="width:900px;height:600px;"></div></div>
				<div id="div_daum" style="display:none;"><div id="roadview" style="width:900px;height:600px;"></div></div>		
			</div>			
			<!-- 무료 상담 시작 -->
	<!-- 		<style>
...
<!--
	...
	(
		function()
		{
			...
			$("li[id='btn_top_menu']").click
			(
				function()
				{
					var para = $(this).attr("data");
					var para2 = $(this).attr("data2");					
					
					$("li[name=btn_top_menu_css]").css("background-color","#ffffff").css("font-weight","").css("font-size","12px");
					
					$(this).css("background-color","#dedede").css("font-weight","bold").css("font-size","13px");

					view_left_start("0","0",para,para2);					
				}
			);
			
			$('img[id=pop_img_info], span[id=pop_img_info]').click(function() {						
				var cIdx = $(this).attr("data");						
								
				location.href = "gallery_view.asp?cIdx="+cIdx+"&data=72&data2=";
			});
			
			function view_left_start(page,min,cate,data2)
			{				
				if (cate == "71")
				{
				...
				{	
					...
					{	
						...
						if(tmp==0)
						{
							page_html = "<span id='view_image_page' name='"+Number(p-1)+"' data_1='"+cate+"' data_2='"+data2+"' style='cursor:pointer;color:#3e3e3e;font-size:16px;"+add_page_class+"'>"+p+"</span>"
							fst_str_arry = view_image_arry[next_num];
						}
						else
						{
							page_html = page_html+" · <span id='view_image_page' name='"+Number(p-1)+"' data_1='"+cate+"' data_2='"+data2+"' style='cursor:pointer;color:#3e3e3e;font-size:16px;"+add_page_class+"'>"+p+"</span>"
							fst_str_arry = fst_str_arry+"|"+view_image_arry[next_num];
						}
				...
				//페이징을 처리합니다.
				$("#view_paging").html(page_html+"&nbsp;");

				$("span[id='view_image_page']").click
				(
					function()
					{					
						var temp_page = Number($(this).attr("name"));
						var temp_code = "72";
						var temp_cate = $(this).attr("data_1");
						var temp_data2 = $(this).attr("data_2");
						var temp_str_arry = fst_str_arry.split("|");	 								
						var nextIdx = temp_str_arry[temp_page].split("ⓒⓗⓡ⑨")[0];							
						
						view_left_start(temp_page,0,temp_cate,temp_data2);							
					}
				);
				...
				for (var i=start_num ; i<loop_end; i++)
				{
					...
					cIdx_list = cIdx_list+"<li><a "+add_class+" id='move_client' cIdx='"+cIdx+"' category_code1='"+category_code1+"' option_code='"+option_code+"' page='"+(Number(page))+"' style='cursor:pointer;"+add_class+"'>&middot; "+cName+"</a></li>"					
		
				}	//for (var i =start_num ; i<loop_end; i++)
				
				$("#move_client_group").html(cIdx_list);
	...
	$(document).on
	(
		"click","a[id='move_client']",
		function()
		{
			var data = $(this).attr("category_code1");
			var data2 = $(this).attr("option_code");
			...
			if (data == "71")
			{
				location.href="gallery_info.asp?cIdx="+cIdx+"&data="+data+"&data2="+data2+"&page="+page;
			}
			if (data == "72")
			{
				location.href="/gallary/gallery_view.asp?cIdx="+cIdx+"&data="+data+"&data2="+data2+"&page="+page;
			}
			if (data == "73")
			{
				location.href="gallery_info.asp?cIdx="+cIdx+"&data="+data+"&data2="+data2+"&page="+page;
...
//-->
       ...
       <!--오른쪽 텍스트링크영역-->
        <div class="popup_menu_right">
        	<div class="menu_title">
				...
				<li id="btn_top_menu" name="btn_top_menu_css" data="72" style="cursor:pointer;background-color:#dedede;font-weight:bold;">스튜디오</li> 
				<li id="btn_top_menu" name="btn_top_menu_css" data="71" style="cursor:pointer;">드레스</li>
				<li id="btn_top_menu" name="btn_top_menu_css" data="73" style="cursor:pointer;">헤어메이크업</li>
				<li id="btn_top_menu" name="btn_top_menu_css" data="72" data2="76" style="cursor:pointer;">웨딩홀</li>		
				</span>
            </div>
            <div class="popup_menu_wrap">
            	<ul class="popup_menu_list">               	
                	<span id="move_client_group">
                	<li><a color:#3e3e3e;="" id="move_client" cidx="1118" category_code1="72" option_code="75" page="0" style="cursor:pointer;color:#3e3e3e;">· 퍼스트모션에프원</a></li>
                	<li><a color:#3e3e3e;="" id="move_client" cidx="914" category_code1="72" option_code="75" page="0" style="cursor:pointer;color:#3e3e3e;">· 피아스튜디오</a></li>
                	<li><a color:#078c77;font-weight:bold;="" id="move_client" cidx="1184" category_code1="72" option_code="75" page="0" style="cursor:pointer;color:#078c77;font-weight:bold;">· 플레하우스</a></li>
                	<!-- <li><a color:#3e3e3e;="" id="move_client" cidx="1054" category_code1="72" option_code="75" page="0" style="cursor:pointer;color:#3e3e3e;">· 무이스튜디오한남</a></li>
                ...
                <span id="view_paging">
                <span id="view_image_page" name="0" data_1="72" data_2="" style="cursor:pointer;color:#3e3e3e;font-size:16px;font-weight:bold;font-size:17px;color:#d01212;">1</span> · <span id="view_image_page" name="1" data_1="72" data_2="" style="cursor:pointer;color:#3e3e3e;font-size:16px;">2</span> · <span id="view_image_page" name="2" data_1="72" data_2="" style="cursor:pointer;color:#3e3e3e;font-size:16px;">3</span> · <span id="view_image_page" name="3" data_1="72" data_2="" style="cursor:pointer;color:#3e3e3e;font-size:16px;">4</span> · <span id="view_image_page" name="4" data_1="72" data_2="" style="cursor:pointer;color:#3e3e3e;font-size:16px;">5</span>&nbsp;</span></div>				             
     ...
     <p class="rolling_logo"><img src="../images/gallay_logo.png" alt="로고"></p>
</div>
<div style="border-bottom:1px solid #d9d9d9; width:1280px; margin:0 auto; height:1px; clear:both;">&nbsp;</div>
<!--<div class="pop_mid_wrap">
	<div class="pop_mid_leftbx">
     	<div class="pop_topbx1">
          	<span>&bull; 추가혜택 및 서비스</span>
          </div>
          <div class="pop_M_textbx01">
          	<span><div class="pop_TXbx01">&bull;운영시간 :</div> 09:00 ~ 17:00</span>
               <span><div class="pop_TXbx01">&bull; 연락처:</div> 010-1133-4455</span>
               <span><div class="pop_TXbx01">&bull; 지역정보:</div> 서울특별시 종로구 123-1234</span>
               <span><div class="pop_TXbx01">&bull; 혜택 / 서비스:</div> 기타특이사항이 있습니다.</span>
               <span><div class="pop_TXbx01">&bull; 주의사항:</div> 기타주의 사항이 있습니다.</span>
               <span><div class="pop_TXbx01">&bull; 주의사항:</div> 기타주의 사항이 있습니다.</span>
               <span><div class="pop_TXbx01">&bull; 주의사항:</div> 기타주의 사항이 있습니다.</span>
               <span><div class="pop_TXbx01">&bull; 주의사항:</div> 기타주의 사항이 있습니다.</span>
               <span><div class="pop_TXbx01">&bull;운영시간 :</div> 09:00 ~ 17:00</span>
     ...
     <div class="pop_mid_rightbx">
     	<div class="pop_topbx2">
          	<span>&bull; 간략소개</span>
          </div>
          <div class="pop_M_textbx02">
          	<span>비용을 다시 페이백 받을수 있도록 준비하였습니다.비용을 다시 페이백 받을수 있도록 준비하였습니다.비용을 다시 페이백 받을수 있도록 준비하였습니다.비용을 다시 페이백 받을수 있도록 준비하였습니다.</span>
               <span>비용을 다시 페이백 받을수 있도록 준비하였습니다.</span>
               <span>비용을 다시 페이백 받을수 있도록 준비하였습니다.</span>
               <span>비용을 다시 페이백 받을수 있도록 준비하였습니다.</span>
               <span>비용을 다시 페이백 받을수 있도록 준비하였습니다.</span>
               <span>비용을 다시 페이백 받을수 있도록 준비하였습니다.</span>
...
<div class="pop_SStudio_wrap">
	<div class="pop_SStudio_leftbx">
     	<div class="pop_SStudio_LTtitlebx"><span>스튜디오 정보</span></div>
     	<div class="online_write_button">
	<span class="btn_input">
    	<a href="studio_modifyView?infoId=${map.stuDto.infoId }"><span class="btn_input"><input type="button" class="online_lg_color" id="regist_btn" value="수정하기" style="cursor:pointer;font-family: NanumBarunGothic;"></span></a>
...
<!-- <div class="online_write_button">
		<span class="online_center">
			<span class="button_pack">
                <span class="btn_input"><button type="button" class="online_lg_color" id="regist_btn" style="cursor:pointer;font-family: NanumBarunGothic;" onclick="InfoSwriteCheck()">저장하기</button></span>
