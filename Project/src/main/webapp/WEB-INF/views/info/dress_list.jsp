...
<div id="wrap">
	...
	<div id="container">
		...
		<!-- maxcontents -->
		<div id="maxcontents">
			<div class="banner"><img src="../images/img/product_banner01.jpg" alt="" class="web" /><img src="../images/img/product_banner01_m.jpg" alt="원두커피, 원두커피 전문 기업 쟈뎅의 Coffee Master의 심혈을 기울인 엄선된 원두 선별, 일반 원두커피부터 간편하게 즐기는 원두커피백, POD까지 다양하게 구성되어 있습니다." class="mobile" /></div>
			...
			<div class="brandList">
				<ul>
					...
					<li>
						<a href="detail">
							<div class="img"><img src="../images/img/sample_brand.jpg" alt="피아스튜디오이미지" /></div>
							<div class="name">피아 스튜디오<br/></div>
						</a>
					</li>
					<!-- //반복 -->
